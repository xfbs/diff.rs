            ...
            <div class="flex-1">
                ...
                <Content>
                    <div class="max-w-2xl m-auto p-4 pt-12">
                        <p>{ "View the differences between Rust crate versions. Enter a crate name such as "}<Link to={Route::Crate { name: "serde".into()}}>{"serde"}</Link>{" in the search field in the top-right corner to get started." }</p>
